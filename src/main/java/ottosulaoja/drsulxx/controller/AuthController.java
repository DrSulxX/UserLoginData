...
import org.springframework.transaction.annotation.Transactional; // Added for transactional handling
...
public class AuthController {
     ...
     */
    @PostMapping("/login")
    @Transactional(transactionManager = "securityTransactionManager") // Added to specify the correct transaction manager
